...
@section('title') {{{ 'Suspended User List' }}} @parent @stop {{-- Content --}}
@section('content')
            ...
            <section id="content"> 
                <section class="vbox"> 
                    ...
                    <header class="header bg-white b-b b-light"> 
                        <p><strong>Suspended User List</strong></p>
...
<!--END PAGE WRAPPER-->
@section('scriptjs')
<script src="{{URL::asset('assets/admin/js/suspended_user_list.js')}}"></script>
@stop
@stop
