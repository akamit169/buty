...
@section('title') {{{ 'Flagged User List' }}} @parent @stop {{-- Content --}}
@section('content')
...
<!--END PAGE WRAPPER-->
@section('scriptjs')
<script src="{{URL::asset('assets/admin/js/flagged_user_list.js')}}"></script>
@stop
@stop
