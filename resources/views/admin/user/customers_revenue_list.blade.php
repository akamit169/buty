...
@section('title') {{{ 'Highest Revenue User List' }}} @parent @stop {{-- Content --}}
@section('content')
...
<!--END PAGE WRAPPER-->
@section('scriptjs')
<script src="{{URL::asset('assets/admin/js/customer_overall_revenue_list.js')}}"></script>
@stop
@stop
